...
ConsoleUI.CHANGELOG = {
    {
        ...
        lines = {
            "New cast bar",
            "New XP / reputation bars",
            "New HUD bar offsets",
            "New Blizz Frames minimap and auras",
            "New touch bar Y offset",
            "New Spell Placement clear",
            "New cursor frames",
            "Fixed settings arrows",
            "Fixed bind save",
            "BREAKING: HUD bar look and default position",
        },
    },
    {
        version = "1.0.0-RC4.1",
