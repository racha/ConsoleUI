...
ConsoleUI_translation["enUS"] = {
    ...
    ["Controller Style is diamonds. Flat is one row of squares. Full shows LB, default, and LT clusters at once."] = "Controller Style is diamonds. Flat is one row of squares. Full shows LB, default, and LT clusters at once.",
