...
ConsoleUI_translation["enUS"] = {
    ...
    ["Classic"] = "Classic",
    ["Modern"] = "Modern",
    ["Split Flanks"] = "Split Flanks",
    ["Minimal"] = "Minimal",
    ["Gold border"] = "Gold border",
    ["Show a gold outline on action-bar diamonds."] = "Show a gold outline on action-bar diamonds.",
    ["Split Flanks is the d-pad / face clusters with RT and RB outside. Minimal is one row."] = "Split Flanks is the d-pad / face clusters with RT and RB outside. Minimal is one row.",
    ["Space between buttons in Minimal layout. Range: 0-100."] = "Space between buttons in Minimal layout. Range: 0-100.",
    ["X Offset"] = "X Offset",
    ["Y Offset"] = "Y Offset",
