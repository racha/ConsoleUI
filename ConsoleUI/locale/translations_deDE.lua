--[[
    ConsoleUI - German (DE) Translations
]]
...
ConsoleUI_translation["deDE"] = {
    ...
    ["Hide Default Bars"] = "Standardleisten ausblenden",
    ["Hide Blizzard action bars. Uncheck to show them again this session."] = "Blizzard-Aktionsleisten ausblenden. Deaktivieren, um sie in dieser Sitzung wieder anzuzeigen.",
    ...
    ["Width of XP bar in pixels. Set to 0 to use the default width (400)."] = "Breite der EP-Leiste in Pixeln. Auf 0 setzen für die Standardbreite (400).",
    ...
    ["Width of Reputation bar in pixels. Set to 0 to use the default width (400)."] = "Breite der Ruf-Leiste in Pixeln. Auf 0 setzen für die Standardbreite (400).",
    ...
    ["Enable the custom cast bar that appears above the XP and reputation bars."] = "Aktiviert die benutzerdefinierte Zauberleiste über den EP- und Rufleisten.",
    ...
    ["Scale"] = "Skalierung",
    ["Size: 20-80, Padding: 0-100, Star Padding: 50-1000, Scale: 0.5-2.0. X/Y offset from bottom center."] = "Größe: 20-80, Abstand: 0-100, Stern-Abstand: 0-2000, Skalierung: 0.5-2.0. X/Y-Offset von unten Mitte.",
    ...
    ["Space between left and right button groups. Range: 50-1000."] = "Abstand zwischen linker und rechter Button-Gruppe. Bereich: 0-2000.",
